...
useEffect(()=>{
  ...
  return (
    ...
    overflow-hidden'>
     ...
     className='bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-2xl p-8 w-full mx-w-md'>
            ...
            <form onSubmit={handleSubmit} className='space-y-6'>
                <div className="flex justify-between">
                    ...
                    className='w-10 h-10 text-center text-xl font-bold bg-gray-700 text-white border-2 border-gray-800 rounded-lg focus:border-green-500 focus:outline-none'/>
                    ))}
                </div>
